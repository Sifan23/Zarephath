      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-14 items-center">
        ...
        <div>
          ...
          <p className="text-gray-800 mb-4 leading-relaxed">
            ...
            on producing natural, unadulterated food products to promote consumer
            health and wellness. Founded by Pauline Okorie, the company is guided
            by a clear vision: to be a leading African brand known for delivering
            natural, healthy, and preservative-free food products that promote
            wellness and prevent lifestyle-related illnesses, both locally and
            globally.
          </p>
          <p className="text-gray-800 mb-8 leading-relaxed">
            Its mission is equally compelling: to produce, package, and distribute
            high-quality, unadulterated food products sourced from sustainable
            agriculture, ensuring every household, at home and abroad, has access to
            nutritious, safe, and naturally processed food.
            {showMore && (
              <>
                {" "}
                <br/>
                The Vision of the organization is also supported by an astute
                investor, shareholder, and advisor Mr. Agbetoyin, who believes in
                healthy living and good manufacturing practices.
                <br/>
                Operating from Lagos, Nigeria, Zarephath specializes in the processing and packaging of unripe plantain flour, red palm oil, yellow and white garri, and roasted peanuts—sourced from farmers who adhere to sustainable agricultural practices.
              </>
            )}
          </p>
